...
namespace HKaurFinalProject
{
    ...
    public class GameScreen: Screen
    {
        ...
        /// <summary>
        /// GameScreen constructor to load the images, fonts, music, sounds, and list of menuItems
        /// </summary>
        ...
        public void Reset()
        {
            ...
            //bird
            bird = new Bird("Music/hit", tex1: "Images/pinkbird1", tex2: "Images/pinkbird2", tex3: "Images/pinkbird3", tex4: "Images/pinkbird4");
        ...
        public override void Update()
        {
            ...
            {
                //calls the notify method of Game1 if Escape key is pressed
                parent.Notify(this, "Escape");
            }
            if (ks.IsKeyDown(Keys.Back) && oldstate.IsKeyUp(Keys.Back))
            {
                //calls the notify method of Game1 if Backspace key is pressed
                parent.Notify(this, "Backspace");
            }
            if (ks.IsKeyDown(Keys.LeftShift) && oldstate.IsKeyUp(Keys.LeftShift))
            {
                //calls the notify method of Game1 if Left key is pressed
